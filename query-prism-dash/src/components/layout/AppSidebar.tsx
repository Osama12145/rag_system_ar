...
import { LayoutDashboard, Library, MessageSquareText, Settings, Hexagon, Activity, Zap } from "lucide-react";
      ...
      <div className="glass-strong flex h-full flex-col rounded-2xl p-4">
        ...
        <div className="mt-4 rounded-xl border border-border/60 bg-card/40 p-3 backdrop-blur">
          <div className="flex items-center justify-between">
            ...
            >
              <span
                className={`h-1.5 w-1.5 rounded-full ${qdrant.active ? "bg-success animate-pulse-glow" : "bg-destructive"}`}
              />
